...
<form action="{{ url('class-reservation') }}" class="form-container" method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="email" name="email" class="form-control-plaintext form-label" id="staticEmail" style="border:1px solid white; color:white;" >
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <select  class="form-control-plaintext form-label" name="courseone" id="nameid" style="border:1px solid white; color:white;" >
        <option> </option>
        @foreach($datas as $d)
